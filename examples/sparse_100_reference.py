#!/usr/bin/env python3
"""Reference for examples/sparse_100.mlr — 100 LIF neurons, heterogeneous
drive, ring-lattice recurrent wiring (fan_out=10). Identical update order
and IEEE-754 f64 throughout. Output: 'i step' per spike."""
